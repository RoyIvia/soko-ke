 ...
 */
export const addToCart = async (cartItemInput: CartItemInput, options?: Parameters<typeof customFetch>[1]): Promise<CartItem> => {
...
export const updateCartItem = async (id: number,
    cartItemUpdate: CartItemUpdate, options?: Parameters<typeof customFetch>[1]): Promise<CartItem> => {
 ...
 */
export const removeCartItem = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<void> => {
 ...
 */
export const getTopProducts = async ( options?: Parameters<typeof customFetch>[1]): Promise<Product[]> => {
