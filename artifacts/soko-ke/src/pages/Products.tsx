...
export function Products() {
  ...
  // We should ideally debounce this properly, but for now we just tie it to form submit or blur
    ...
    <ShopLayout>
      <div className="bg-muted/30 border-b">
        <div className="container mx-auto px-4 md:px-6 py-8">
          <h1 className="text-3xl md:text-4xl font-bold font-serif text-foreground mb-4">All Products</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {isLoading ? (
              ...
              <div className="col-span-full py-12 text-center">
                ...
                <Button variant="outline" onClick={() => { setSearchTerm(""); setCategory(""); setDebouncedSearch(""); }}>
                  Clear Filters
                </Button>
              </div>
            ) : (
                  ...
                  <Card className="group cursor-pointer overflow-hidden border-transparent shadow-none bg-transparent hover:bg-muted/30 transition-colors p-3 h-full flex flex-col">
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      <h3 className="font-bold text-base mb-2 group-hover:text-primary transition-colors line-clamp-2 leading-tight flex-1">
                       ...
                       <p className="text-xs text-muted-foreground mb-2">{product.ownerType === "merchant" ? `Sold by ${product.sellerName || "verified merchant"}` : "SokoKE owned"}</p>
